...
const ErrorPage = () => {
  return (
    <>
      <div className="container w-screen h-screen flex flex-col md:flex-row items-center justify-center px-5 text-gray-700  ">
        <div className="">
          <img
            className="w-full object-cover"
            src="https://i.ibb.co/TKLftQz/error.jpg"
            alt=""
          />
        </div>
        <div className="mb-20">
          <div className="text-6xl font-dark font-bold text-blue-700 pb-3">
            404
          </div>
